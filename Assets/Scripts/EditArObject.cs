    ...
    private void Update()
    {
        ...
        else if (Touch.activeTouches.Count == 2)
        {
            ...
            if (touchZero.phase == TouchPhase.Moved || touchOne.phase == TouchPhase.Moved)
            {
                ...
                float prevAngle = Mathf.Atan2(touchZeroPrevPosition.y - touchOnePrevPosition.y, touchZeroPrevPosition.x - touchOnePrevPosition.x);
                ...
                GameManager.Instance.currObj.transform.Rotate(Vector3.up, deltaAngle, Space.World);
            }
        }
